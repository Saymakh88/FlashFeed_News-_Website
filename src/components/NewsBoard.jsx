...
const NewsBoard = ({ category }) => {
  ...
  useEffect(() => {
    const url = `https://gnews.io/api/v4/search?q=${category}&lang=en&country=us&max=10&apikey=${
...
//           `https://gnews.io/api/v4/search?q=example&lang=en&country=us&category=${category}&max=10&apikey=${
